...
namespace SepcflowSelenium.StepDefinitions
{
    ...
    public class YoutubeSearchFeatureSteps : IDisposable //used to remove unused resources
    {
        ...
        {
            ScenarioContext.Current["searchKey"] = searchString.ToLower();
                ...
                public void WhenIPressTheSearchButton()
{
    ...
    public void ThenIShouldNavigateToSearchResultsPage()
    {
        ...
        System.Threading.Thread.Sleep(2000); //pause thread for 5 seconds
            var expectedSearchKey = (String)ScenarioContext.Current["searchKey"];
